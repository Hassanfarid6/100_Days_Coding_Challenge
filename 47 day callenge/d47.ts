...
**Explain & TIP:** The `await` operator is used to wait for a `Promise` to settle. It can only be used inside an 
`async` function. Using `await` makes asynchronous code look and behave a little more like synchronous code,
