...
*Explain & TIP:* The Math.abs() function returns the absolute value of a number, which is useful for finding
 the magnitude of a difference without regard to direction.*/

function absoluteValue(){
    return Math.abs(-5 - 5);
}
let absolute: number = absoluteValue()
