...
let name: string = "hassan ali"
console.log(`Hello ${name}, Would you like to learn some typeSript today?`) // This shows the message;*/
...
console.log(name.charAt(0).charAt(9).toUpperCase() + name.slice(1).toLowerCase());
export {};
