...
//Answer of Q16:
let guest1: string[] = ["Hassaan_Farid", "Yaqoob_Qadir", "Faisal_Qadir"];
...
let guests: string[] = ["Ahmed_Ali", "Muhammad_Ali", "Arif_Basheer"];
...
let places: string [] = ["Isalamabad", "Quetta", "Peshawar", "Turbat", "Thatta", "Haiderabad"]
...
*Explain & TIP:* Arrays have a length property that tells you how many items are in the list.
 ...
 let guets: string[] = ["Hassan_Ali", "Fahan_Ahmed", "Muhammad_Yaqoob", "Usama_Ashraf", "Usman_Baloch", 
                          "Akram_jameel"];
